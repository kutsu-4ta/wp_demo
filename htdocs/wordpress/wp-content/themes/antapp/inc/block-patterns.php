 ...
 * @return void
 */
function antapp_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'antapp' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'antapp' ) ),
		'header'   => array( 'label' => __( 'Headers', 'antapp' ) ),
		'query'    => array( 'label' => __( 'Query', 'antapp' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'antapp' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'antapp_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'antapp_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'antapp/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'antapp_register_block_patterns', 9 );
